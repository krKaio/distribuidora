...
<html>
    ...
    <body> 
        <section id="caixa"> 
            ...
            <br>
            <form name="meuForm" action="AlterarMensal.jsp" method="post">
                <ul>
                ...
                <div id="cliente">
                    ...
                    <span>Idade:</span> <input type="text" id="idade" name="idade" value='<%=results.getString("idade")%>' style="margin-left: 55px"required><br><br>
